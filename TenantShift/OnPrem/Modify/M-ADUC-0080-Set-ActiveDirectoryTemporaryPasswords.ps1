...
.SYNOPSIS
    Modifies ActiveDirectoryTemporaryPasswords in Active Directory.

.DESCRIPTION
    Updates ActiveDirectoryTemporaryPasswords in Active Directory based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M0010-Set-ActiveDirectoryTemporaryPasswords.ps1 -InputCsvPath .\0010.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M0010-Set-ActiveDirectoryTemporaryPasswords.ps1 -InputCsvPath .\0010.input.csv -WhatIf
...
.NOTES
    ...
    UnlockAccount          String    Yes       <fill in description>
    EnableAccount          String    Yes       <fill in description>
#>
