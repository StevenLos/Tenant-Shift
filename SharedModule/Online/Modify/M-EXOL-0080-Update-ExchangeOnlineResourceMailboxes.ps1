...
.SYNOPSIS
    Modifies ExchangeOnlineResourceMailboxes in Microsoft 365.

.DESCRIPTION
    Updates ExchangeOnlineResourceMailboxes in Microsoft 365 based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M3118-Update-ExchangeOnlineResourceMailboxes.ps1 -InputCsvPath .\3118.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M3118-Update-ExchangeOnlineResourceMailboxes.ps1 -InputCsvPath .\3118.input.csv -WhatIf
