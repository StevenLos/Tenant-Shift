...
.SYNOPSIS
    Modifies ExchangeOnPremMailboxDelegations in Active Directory.

.DESCRIPTION
    Updates ExchangeOnPremMailboxDelegations in Active Directory based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M0220-Set-ExchangeOnPremMailboxDelegations.ps1 -InputCsvPath .\0220.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M0220-Set-ExchangeOnPremMailboxDelegations.ps1 -InputCsvPath .\0220.input.csv -WhatIf
