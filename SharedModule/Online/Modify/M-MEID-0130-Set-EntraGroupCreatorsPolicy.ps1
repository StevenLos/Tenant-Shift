...
.SYNOPSIS
    Modifies EntraGroupCreatorsPolicy in Microsoft 365.

.DESCRIPTION
    Updates EntraGroupCreatorsPolicy in Microsoft 365 based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M3009-Set-EntraGroupCreatorsPolicy.ps1 -InputCsvPath .\3009.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M3009-Set-EntraGroupCreatorsPolicy.ps1 -InputCsvPath .\3009.input.csv -WhatIf
...
.NOTES
    ...
    AllowGroupCreation         String    Yes       <fill in description>
    AllowedGroupIdentityType   String    Yes       <fill in description>
    AllowedGroupIdentityValue  String    Yes       <fill in description>
    ClearAllowedGroup          String    Yes       <fill in description>
#>
