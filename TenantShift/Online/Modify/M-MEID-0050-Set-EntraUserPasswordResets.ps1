...
.SYNOPSIS
    Modifies EntraUserPasswordResets in Microsoft 365.

.DESCRIPTION
    Updates EntraUserPasswordResets in Microsoft 365 based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M3004-Set-EntraUserPasswordResets.ps1 -InputCsvPath .\3004.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M3004-Set-EntraUserPasswordResets.ps1 -InputCsvPath .\3004.input.csv -WhatIf
