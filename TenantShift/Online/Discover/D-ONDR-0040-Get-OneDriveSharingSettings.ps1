...
.EXAMPLE
    .\SM-D3207-Get-OneDriveSharingSettings.ps1 -InputCsvPath .\3207.input.csv

    Inventory the objects listed in the input CSV file.

.EXAMPLE
    .\SM-D3207-Get-OneDriveSharingSettings.ps1 -DiscoverAll
...
param(
    ...
    [string]$OutputCsvPath = (Join-Path -Path (Join-Path -Path $PSScriptRoot -ChildPath 'Discover_OutputCsvPath') -ChildPath ("Results_D-ONDR-0040-Get-OneDriveSharingSettings_{0}.csv" -f (Get-Date -Format 'yyyyMMdd-HHmmss')))
)
