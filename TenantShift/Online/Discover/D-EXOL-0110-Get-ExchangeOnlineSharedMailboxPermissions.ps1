...
.EXAMPLE
    .\SM-D3117-Get-ExchangeOnlineSharedMailboxPermissions.ps1 -InputCsvPath .\3117.input.csv

    Inventory the objects listed in the input CSV file.

.EXAMPLE
    .\SM-D3117-Get-ExchangeOnlineSharedMailboxPermissions.ps1 -DiscoverAll
...
param(
    ...
    [string]$OutputCsvPath = (Join-Path -Path (Join-Path -Path $PSScriptRoot -ChildPath 'Discover_OutputCsvPath') -ChildPath ("Results_D-EXOL-0110-Get-ExchangeOnlineSharedMailboxPermissions_{0}.csv" -f (Get-Date -Format 'yyyyMMdd-HHmmss')))
)
