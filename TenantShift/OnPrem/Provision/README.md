...
`TenantShift/OnPrem/Provision` is for planned create and initial setup scripts targeting on-prem workloads.
...
- Ongoing updates to existing objects (use `TenantShift/OnPrem/Modify`)
- Read-only discovery exports (use `TenantShift/OnPrem/Discover`)
