...
.EXAMPLE
    .\SM-IR0225-Get-ExchangeOnPremOutlookClientVersionsFromRpcLogs.ps1 -InputCsvPath .\0225.input.csv

    Inventory the objects listed in the input CSV file.

.EXAMPLE
    .\SM-IR0225-Get-ExchangeOnPremOutlookClientVersionsFromRpcLogs.ps1 -DiscoverAll
