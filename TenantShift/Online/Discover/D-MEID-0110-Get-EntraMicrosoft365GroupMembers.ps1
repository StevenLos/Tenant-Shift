...
.EXAMPLE
    .\SM-D3010-Get-EntraMicrosoft365GroupMembers.ps1 -InputCsvPath .\3010.input.csv

    Inventory the objects listed in the input CSV file.

.EXAMPLE
    .\SM-D3010-Get-EntraMicrosoft365GroupMembers.ps1 -DiscoverAll
...
param(
    ...
    [string]$OutputCsvPath = (Join-Path -Path (Join-Path -Path $PSScriptRoot -ChildPath 'Discover_OutputCsvPath') -ChildPath ("Results_D-MEID-0110-Get-EntraMicrosoft365GroupMembers_{0}.csv" -f (Get-Date -Format 'yyyyMMdd-HHmmss')))
)
