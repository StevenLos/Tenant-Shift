...
param(
    ...
    [string]$OutputCsvPath = (Join-Path -Path (Join-Path -Path $PSScriptRoot -ChildPath 'Provision_OutputCsvPath') -ChildPath ("Results_P0009-Create-ActiveDirectoryOrganizationalUnits_{0}.csv" -f (Get-Date -Format 'yyyyMMdd-HHmmss')))
)
