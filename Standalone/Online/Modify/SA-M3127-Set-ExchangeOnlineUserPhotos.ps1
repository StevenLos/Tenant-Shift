...
param(
    ...
    [string]$OutputCsvPath = (Join-Path -Path (Join-Path -Path $PSScriptRoot -ChildPath '..\\..\\Standalone_OutputCsvPath') -ChildPath ("Results_SA-M3127-Set-ExchangeOnlineUserPhotos_{0}.csv" -f (Get-Date -Format 'yyyyMMdd-HHmmss')))
)
