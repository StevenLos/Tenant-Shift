...
- Implemented OnPrem ActiveDirectory and ExchangeOnPrem batch 1 inventory/report scripts (`IR0001`, `IR0002`, `IR0005`, `IR0006`, `IR0007`, `IR0008`, `IR0009`, `IR0213`, `IR0214`, `IR0222`, `IR0223`) also support unbounded directory discovery via `-DiscoverAll`, with optional `-SearchBase`, `-Server`, and `-MaxObjects`.
- Online inventory/report scripts are not changed in this pass; add the same dual-scope discovery pattern there in a future implementation pass.
...
5. Reuse the environment-specific common module:
   ...
   - OnPrem: `./Common/OnPrem/OnPrem.Common.psm1`
