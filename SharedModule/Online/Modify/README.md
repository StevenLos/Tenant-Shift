...
```powershell
pwsh ./SharedModule/Online/Modify/M-MEID-0030-Set-EntraUserLicenses.ps1 -InputCsvPath ./SharedModule/Online/Modify/M-MEID-0030-Set-EntraUserLicenses.input.csv -WhatIf
pwsh ./SharedModule/Online/Modify/M-MEID-0050-Set-EntraUserPasswordResets.ps1 -InputCsvPath ./SharedModule/Online/Modify/M-MEID-0050-Set-EntraUserPasswordResets.input.csv -WhatIf
pwsh ./SharedModule/Online/Modify/M-MEID-0130-Set-EntraGroupCreatorsPolicy.ps1 -InputCsvPath ./SharedModule/Online/Modify/M-MEID-0130-Set-EntraGroupCreatorsPolicy.input.csv -WhatIf
pwsh ./SharedModule/Online/Modify/M-TEAM-0020-Set-MicrosoftTeamMembers.ps1 -InputCsvPath ./SharedModule/Online/Modify/M-TEAM-0020-Set-MicrosoftTeamMembers.input.csv -WhatIf
pwsh ./SharedModule/Online/Modify/M-ONDR-0020-Set-OneDriveStorageQuota.ps1 -InputCsvPath ./SharedModule/Online/Modify/M-ONDR-0020-Set-OneDriveStorageQuota.input.csv -SharePointAdminUrl https://contoso-admin.sharepoint.com -WhatIf
pwsh ./SharedModule/Online/Modify/M-ONDR-0030-Set-OneDriveSiteCollectionAdmins.ps1 -InputCsvPath ./SharedModule/Online/Modify/M-ONDR-0030-Set-OneDriveSiteCollectionAdmins.input.csv -SharePointAdminUrl https://contoso-admin.sharepoint.com -WhatIf
pwsh ./SharedModule/Online/Modify/M-ONDR-0040-Set-OneDriveSharingSettings.ps1 -InputCsvPath ./SharedModule/Online/Modify/M-ONDR-0040-Set-OneDriveSharingSettings.input.csv -SharePointAdminUrl https://contoso-admin.sharepoint.com -WhatIf
pwsh ./SharedModule/Online/Modify/M-ONDR-0050-Revoke-OneDriveExternalSharingLinks.ps1 -InputCsvPath ./SharedModule/Online/Modify/M-ONDR-0050-Revoke-OneDriveExternalSharingLinks.input.csv -SharePointAdminUrl https://contoso-admin.sharepoint.com -WhatIf
pwsh ./SharedModule/Online/Modify/M-ONDR-0060-Set-OneDriveSiteLockState.ps1 -InputCsvPath ./SharedModule/Online/Modify/M-ONDR-0060-Set-OneDriveSiteLockState.input.csv -SharePointAdminUrl https://contoso-admin.sharepoint.com -WhatIf
pwsh ./SharedModule/Online/Modify/M-TEAM-0010-Update-MicrosoftTeams.ps1 -InputCsvPath ./SharedModule/Online/Modify/M-TEAM-0010-Update-MicrosoftTeams.input.csv -WhatIf
pwsh ./SharedModule/Online/Modify/M-SPOL-0030-Set-SharePointSiteAdmins.ps1 -InputCsvPath ./SharedModule/Online/Modify/M-SPOL-0030-Set-SharePointSiteAdmins.input.csv -SharePointAdminUrl https://contoso-admin.sharepoint.com -WhatIf
```

For copy/paste command building, use `./SharedModule/Online/Modify/Modify-Orchestrator.xlsx`.
