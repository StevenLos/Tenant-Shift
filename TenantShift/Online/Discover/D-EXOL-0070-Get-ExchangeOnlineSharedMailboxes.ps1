...
.EXAMPLE
    .\SM-D3116-Get-ExchangeOnlineSharedMailboxes.ps1 -InputCsvPath .\3116.input.csv

    Inventory the objects listed in the input CSV file.

.EXAMPLE
    .\SM-D3116-Get-ExchangeOnlineSharedMailboxes.ps1 -DiscoverAll
...
param(
    ...
    [string]$OutputCsvPath = (Join-Path -Path (Join-Path -Path $PSScriptRoot -ChildPath 'Discover_OutputCsvPath') -ChildPath ("Results_D-EXOL-0070-Get-ExchangeOnlineSharedMailboxes_{0}.csv" -f (Get-Date -Format 'yyyyMMdd-HHmmss')))
)
