...
.SYNOPSIS
    Modifies SharePointSiteAdmins in Microsoft 365.

.DESCRIPTION
    Updates SharePointSiteAdmins in Microsoft 365 based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M3241-Set-SharePointSiteAdmins.ps1 -InputCsvPath .\3241.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M3241-Set-SharePointSiteAdmins.ps1 -InputCsvPath .\3241.input.csv -WhatIf
...
.NOTES
    ...
    AddSiteAdmins              String    Yes       <fill in description>
    RemoveSiteAdmins           String    Yes       <fill in description>
    EnsurePrimaryOwnerIsAdmin  String    Yes       <fill in description>
#>
...
param(
    ...
    [string]$OutputCsvPath = (Join-Path -Path (Join-Path -Path $PSScriptRoot -ChildPath 'Modify_OutputCsvPath') -ChildPath ("Results_SM-M3241-Set-SharePointSiteAdmins_{0}.csv" -f (Get-Date -Format 'yyyyMMdd-HHmmss')))
)
