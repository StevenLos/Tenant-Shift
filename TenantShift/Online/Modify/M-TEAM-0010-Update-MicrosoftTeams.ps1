...
.SYNOPSIS
    Modifies MicrosoftTeams in Microsoft 365.

.DESCRIPTION
    Updates MicrosoftTeams in Microsoft 365 based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M3309-Update-MicrosoftTeams.ps1 -InputCsvPath .\3309.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M3309-Update-MicrosoftTeams.ps1 -InputCsvPath .\3309.input.csv -WhatIf
