...
```
.\TenantShift\OnPrem\Provision\P-ADUC-0020-Create-ActiveDirectoryUsers.ps1
.\TenantShift\OnPrem\Provision\P-ADUC-0020-Create-ActiveDirectoryUsers.input.csv    ← template
```
...
3. Run a corresponding D script against the input CSV to confirm objects do not already exist.
...
```
.\TenantShift\OnPrem\Provision\Provision_OutputCsvPath\
```
...
After a successful run, verify the created objects using the corresponding D script:
