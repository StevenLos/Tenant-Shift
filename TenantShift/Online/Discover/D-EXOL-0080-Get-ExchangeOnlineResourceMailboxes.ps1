...
.EXAMPLE
    .\SM-D3118-Get-ExchangeOnlineResourceMailboxes.ps1 -InputCsvPath .\3118.input.csv

    Inventory the objects listed in the input CSV file.

.EXAMPLE
    .\SM-D3118-Get-ExchangeOnlineResourceMailboxes.ps1 -DiscoverAll
...
param(
    ...
    [string]$OutputCsvPath = (Join-Path -Path (Join-Path -Path $PSScriptRoot -ChildPath 'Discover_OutputCsvPath') -ChildPath ("Results_D-EXOL-0080-Get-ExchangeOnlineResourceMailboxes_{0}.csv" -f (Get-Date -Format 'yyyyMMdd-HHmmss')))
)
