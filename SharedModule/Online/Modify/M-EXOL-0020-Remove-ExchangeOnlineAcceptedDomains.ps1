...
.EXAMPLE
    .\SM-M3131-Remove-ExchangeOnlineAcceptedDomains.ps1 -InputCsvPath .\3131.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M3131-Remove-ExchangeOnlineAcceptedDomains.ps1 -InputCsvPath .\3131.input.csv -WhatIf
...
.NOTES
    ...
    RemoveAcceptedDomain           String    Yes       <fill in description>
    RemoveTenantDomain             String    Yes       <fill in description>
    ForceRemoval                   String    Yes       <fill in description>
    AllowOnMicrosoftDomainRemoval  String    Yes       <fill in description>
