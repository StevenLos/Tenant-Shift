...
.MODULEVERSIONPOLICY
Shared prerequisite engine via SharedModule\Utilities\PrerequisiteEngine.psm1
...
$script:enginePath = Join-Path -Path $script:workspaceRoot -ChildPath 'SharedModule\Utilities\PrerequisiteEngine.psm1'
