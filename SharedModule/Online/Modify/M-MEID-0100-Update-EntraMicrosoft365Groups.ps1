...
.SYNOPSIS
    Modifies EntraMicrosoft365Groups in Microsoft 365.

.DESCRIPTION
    Updates EntraMicrosoft365Groups in Microsoft 365 based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M3008-Update-EntraMicrosoft365Groups.ps1 -InputCsvPath .\3008.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M3008-Update-EntraMicrosoft365Groups.ps1 -InputCsvPath .\3008.input.csv -WhatIf
