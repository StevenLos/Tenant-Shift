...
.SYNOPSIS
    Modifies ExchangeOnPremUserMailboxForwarding in Active Directory.

.DESCRIPTION
    Updates ExchangeOnPremUserMailboxForwarding in Active Directory based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M0224-Set-ExchangeOnPremUserMailboxForwarding.ps1 -InputCsvPath .\0224.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M0224-Set-ExchangeOnPremUserMailboxForwarding.ps1 -InputCsvPath .\0224.input.csv -WhatIf
...
.NOTES
    ...
    ForwardingMode               String    Yes       <fill in description>
    ForwardingSmtpAddress        String    Yes       <fill in description>
    ForwardingRecipientIdentity  String    Yes       <fill in description>
...
param(
    ...
    [string]$OutputCsvPath = (Join-Path -Path (Join-Path -Path $PSScriptRoot -ChildPath 'Modify_OutputCsvPath') -ChildPath ("Results_SM-M0224-Set-ExchangeOnPremUserMailboxForwarding_{0}.csv" -f (Get-Date -Format 'yyyyMMdd-HHmmss')))
)
