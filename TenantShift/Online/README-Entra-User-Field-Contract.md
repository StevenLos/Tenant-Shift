...
- `TenantShift/Online/Modify/M-MEID-0040-Set-EntraUserAccountState.ps1`
...
| CSV Field | Create (P3001) | Update (M3001) | Inventory (D3001) | Clear in M3001 |
|---|---|---|---|---|
...
| CSV Field | Create (P3001) | Update (M3001) | Inventory (D3001) |
|---|---|---|---|
