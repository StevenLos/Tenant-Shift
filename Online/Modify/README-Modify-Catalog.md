...
Current implementation status: foundational update scripts are implemented across Entra, Teams, Exchange Online, and SharePoint/OneDrive, including the planned OneDrive and Teams update wave.
...
|---|---|---|---|---|---|
| M3001 | `M3001-Update-EntraUsers.ps1` | `M3001-Update-EntraUsers.input.csv` | Entra | User profile/attribute updates | Implemented |
| M3002 | `M3002-Set-EntraUserAccountState.ps1` | `M3002-Set-EntraUserAccountState.input.csv` | Entra | Enable/disable accounts | Implemented |
...
| M3207 | `M3207-Set-OneDriveSharingSettings.ps1` | `M3207-Set-OneDriveSharingSettings.input.csv` | OneDrive/SharePoint | Update OneDrive sharing policy posture by user/site | Implemented |
| M3208 | `M3208-Revoke-OneDriveExternalSharingLinks.ps1` | `M3208-Revoke-OneDriveExternalSharingLinks.input.csv` | OneDrive/SharePoint | Revoke scoped OneDrive external links/principal shares | Implemented |
| M3209 | `M3209-Set-OneDriveSiteLockState.ps1` | `M3209-Set-OneDriveSiteLockState.input.csv` | OneDrive/SharePoint | Set OneDrive lock state for lifecycle/incident controls | Implemented |
| M3005 | `M3005-Update-EntraAssignedSecurityGroups.ps1` | `M3005-Update-EntraAssignedSecurityGroups.input.csv` | Entra | Assigned security group property updates | Implemented |
| M3006 | `M3006-Update-EntraDynamicUserSecurityGroups.ps1` | `M3006-Update-EntraDynamicUserSecurityGroups.input.csv` | Entra | Dynamic rule/processing updates | Implemented |
| M3007 | `M3007-Set-EntraSecurityGroupMembers.ps1` | `M3007-Set-EntraSecurityGroupMembers.input.csv` | Entra | Add/remove group members | Implemented |
| M3008 | `M3008-Update-EntraMicrosoft365Groups.ps1` | `M3008-Update-EntraMicrosoft365Groups.input.csv` | Entra | M365 group settings/visibility updates | Implemented |
| M3309 | `M3309-Update-MicrosoftTeams.ps1` | `M3309-Update-MicrosoftTeams.input.csv` | Teams | Team settings updates | Implemented |
...
| M3115 | `M3115-Set-ExchangeOnlineDistributionListMembers.ps1` | `M3115-Set-ExchangeOnlineDistributionListMembers.input.csv` | Exchange Online | Add/remove distribution list members | Implemented |
...
| M3124 | `M3124-Set-ExchangeOnlineUserMailboxForwarding.ps1` | `M3124-Set-ExchangeOnlineUserMailboxForwarding.input.csv` | Exchange Online | Set per-user mailbox forwarding mode and delivery behavior | Implemented |
...
1. Entra and OneDrive changes: `M3001`, `M3002`, `M3003`, `M3005`, `M3006`, `M3007`, `M3008`, `M3204` to `M3209`
2. Teams changes: `M3309` to `M3312`
3. Exchange Online changes: `M3113` to `M3124` (implemented Exchange Online set/update coverage)
