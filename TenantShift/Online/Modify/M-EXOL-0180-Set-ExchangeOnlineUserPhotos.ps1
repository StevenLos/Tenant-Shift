...
.SYNOPSIS
    Modifies ExchangeOnlineUserPhotos in Microsoft 365.

.DESCRIPTION
    Updates ExchangeOnlineUserPhotos in Microsoft 365 based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M3127-Set-ExchangeOnlineUserPhotos.ps1 -InputCsvPath .\3127.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M3127-Set-ExchangeOnlineUserPhotos.ps1 -InputCsvPath .\3127.input.csv -WhatIf
...
.NOTES
    ...
    PhotoPath             String    Yes       <fill in description>
    RemovePhoto           String    Yes       <fill in description>
