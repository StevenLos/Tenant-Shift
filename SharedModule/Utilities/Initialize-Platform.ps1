...
.EXAMPLE
    .\Initialize-Platform.ps1 -Online

    Validate Contributor + OnlineOperator.

.EXAMPLE
    .\Initialize-Platform.ps1 -Profile OnPremOperator

    Validate only the OnPremOperator profile.

.EXAMPLE
    .\Initialize-Platform.ps1 -AuditRepository -RepositoryRoot .
...
function Write-StartupBanner {
    ...
    Write-Host ''
    Write-Host '  Initialize-Platform' -ForegroundColor DarkCyan
