...
.SYNOPSIS
    Modifies ExchangeOnPremMailboxFolderPermissions in Active Directory.

.DESCRIPTION
    Updates ExchangeOnPremMailboxFolderPermissions in Active Directory based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M0221-Set-ExchangeOnPremMailboxFolderPermissions.ps1 -InputCsvPath .\0221.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M0221-Set-ExchangeOnPremMailboxFolderPermissions.ps1 -InputCsvPath .\0221.input.csv -WhatIf
...
.NOTES
    ...
    TrusteeIdentity              String    Yes       <fill in description>
    FolderPath                   String    Yes       <fill in description>
    PermissionAction             String    Yes       <fill in description>
...
param(
    ...
    [string]$OutputCsvPath = (Join-Path -Path (Join-Path -Path $PSScriptRoot -ChildPath 'Modify_OutputCsvPath') -ChildPath ("Results_SM-M0221-Set-ExchangeOnPremMailboxFolderPermissions_{0}.csv" -f (Get-Date -Format 'yyyyMMdd-HHmmss')))
)
