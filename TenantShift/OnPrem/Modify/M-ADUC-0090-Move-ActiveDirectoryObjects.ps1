...
.SYNOPSIS
    Modifies ActiveDirectoryObjects in Active Directory.

.DESCRIPTION
    Updates ActiveDirectoryObjects in Active Directory based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M0009-Move-ActiveDirectoryObjects.ps1 -InputCsvPath .\0009.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M0009-Move-ActiveDirectoryObjects.ps1 -InputCsvPath .\0009.input.csv -WhatIf
...
.NOTES
    ...
    ObjectType            String    Yes       <fill in description>
    IdentityType          String    Yes       <fill in description>
    IdentityValue         String    Yes       <fill in description>
    TargetPath            String    Yes       <fill in description>
    NewName               String    Yes       <fill in description>
...
param(
    ...
    [string]$OutputCsvPath = (Join-Path -Path (Join-Path -Path $PSScriptRoot -ChildPath 'Modify_OutputCsvPath') -ChildPath ("Results_SM-M0009-Move-ActiveDirectoryObjects_{0}.csv" -f (Get-Date -Format 'yyyyMMdd-HHmmss')))
)
