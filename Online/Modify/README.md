...
Current status: update baseline scripts are implemented for Entra licensing/membership, Teams membership/channels, Exchange Online recipient/group updates and permission/delegation, and SharePoint admin/hub association flows.
...
| M3007 | `M3007-Set-EntraSecurityGroupMembers.ps1` | Entra | Add users to existing security groups. |
...
| M3115 | `M3115-Set-ExchangeOnlineDistributionListMembers.ps1` | Exchange Online | Add members to existing distribution lists. |
...
|---|---|---|---|
| M3001 | `M3001-Update-EntraUsers.ps1` | Entra | Update user profile attributes. |
| M3002 | `M3002-Set-EntraUserAccountState.ps1` | Entra | Enable/disable user accounts. |
| M3005 | `M3005-Update-EntraAssignedSecurityGroups.ps1` | Entra | Update assigned security group properties. |
| M3006 | `M3006-Update-EntraDynamicUserSecurityGroups.ps1` | Entra | Update dynamic membership rules/settings. |
| M3008 | `M3008-Update-EntraMicrosoft365Groups.ps1` | Entra | Update M365 group properties/visibility. |
| M3207 | `M3207-Set-OneDriveSharingSettings.ps1` | OneDrive/SharePoint | Update OneDrive sharing policy posture by user/site. |
| M3208 | `M3208-Revoke-OneDriveExternalSharingLinks.ps1` | OneDrive/SharePoint | Revoke OneDrive external sharing links in scoped cleanup runs. |
...
| M3309 | `M3309-Update-MicrosoftTeams.ps1` | Teams | Update Team settings. |
