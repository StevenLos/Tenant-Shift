...
`TenantShift/OnPrem/Modify` is for planned update/change scripts targeting existing on-prem objects.
...
- Initial object creation (use `TenantShift/OnPrem/Provision`)
- Read-only reporting (use `TenantShift/OnPrem/Discover`)
