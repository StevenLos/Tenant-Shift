...
Run `../Initialize-TenantShift/Initialize-TenantShift.ps1 -Profile OnlineOperator` to verify your operator environment before running Online scripts. Use `-Online` only when you also want the `Contributor` profile validated on the same host.

## Operation Folders

- `TenantShift/Online/Provision/` — initial object creation
- `TenantShift/Online/Modify/` — updates to existing objects
- `TenantShift/Online/Discover/` — read-only inventory and reporting
...
| Discover (`D`) | Implemented | Implemented | Implemented | Implemented |
...
- [Online Discover README](./Discover/README.md)
- [Online Discover Detailed Catalog](./Discover/README-Discover-Catalog.md)
