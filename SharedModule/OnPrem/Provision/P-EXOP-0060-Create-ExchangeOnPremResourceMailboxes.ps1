...
.SYNOPSIS
    Provisions ExchangeOnPremResourceMailboxes in Active Directory.

.DESCRIPTION
    Creates ExchangeOnPremResourceMailboxes in Active Directory based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-P0218-Create-ExchangeOnPremResourceMailboxes.ps1 -InputCsvPath .\0218.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-P0218-Create-ExchangeOnPremResourceMailboxes.ps1 -InputCsvPath .\0218.input.csv -WhatIf
