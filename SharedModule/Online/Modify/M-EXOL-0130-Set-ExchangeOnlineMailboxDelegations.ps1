...
.SYNOPSIS
    Modifies ExchangeOnlineMailboxDelegations in Microsoft 365.

.DESCRIPTION
    Updates ExchangeOnlineMailboxDelegations in Microsoft 365 based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M3120-Set-ExchangeOnlineMailboxDelegations.ps1 -InputCsvPath .\3120.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M3120-Set-ExchangeOnlineMailboxDelegations.ps1 -InputCsvPath .\3120.input.csv -WhatIf
