...
.SYNOPSIS
    Modifies OneDriveExternalSharingLinks in Microsoft 365.

.DESCRIPTION
    Updates OneDriveExternalSharingLinks in Microsoft 365 based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M3208-Revoke-OneDriveExternalSharingLinks.ps1 -InputCsvPath .\3208.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M3208-Revoke-OneDriveExternalSharingLinks.ps1 -InputCsvPath .\3208.input.csv -WhatIf
...
.NOTES
    ...
    ExternalUserEmails           String    Yes       <fill in description>
    RevokeAllExternalUsers       String    Yes       <fill in description>
    IncludeSiteCollectionAdmins  String    Yes       <fill in description>
#>
...
param(
    ...
    [string]$OutputCsvPath = (Join-Path -Path (Join-Path -Path $PSScriptRoot -ChildPath 'Modify_OutputCsvPath') -ChildPath ("Results_SM-M3208-Revoke-OneDriveExternalSharingLinks_{0}.csv" -f (Get-Date -Format 'yyyyMMdd-HHmmss')))
)
