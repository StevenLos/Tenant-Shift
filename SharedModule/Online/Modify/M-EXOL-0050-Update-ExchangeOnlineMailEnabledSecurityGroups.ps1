...
.SYNOPSIS
    Modifies ExchangeOnlineMailEnabledSecurityGroups in Microsoft 365.

.DESCRIPTION
    Updates ExchangeOnlineMailEnabledSecurityGroups in Microsoft 365 based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M3122-Update-ExchangeOnlineMailEnabledSecurityGroups.ps1 -InputCsvPath .\3122.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M3122-Update-ExchangeOnlineMailEnabledSecurityGroups.ps1 -InputCsvPath .\3122.input.csv -WhatIf
