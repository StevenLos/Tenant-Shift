...
.SYNOPSIS
    Modifies ExchangeOnlineUserMailboxForwarding in Microsoft 365.

.DESCRIPTION
    Updates ExchangeOnlineUserMailboxForwarding in Microsoft 365 based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M3124-Set-ExchangeOnlineUserMailboxForwarding.ps1 -InputCsvPath .\3124.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M3124-Set-ExchangeOnlineUserMailboxForwarding.ps1 -InputCsvPath .\3124.input.csv -WhatIf
