...
.SYNOPSIS
    Modifies ExchangeOnPremMailEnabledSecurityGroups in Active Directory.

.DESCRIPTION
    Updates ExchangeOnPremMailEnabledSecurityGroups in Active Directory based on records provided in the input CSV file.
...
.EXAMPLE
    .\SM-M0222-Update-ExchangeOnPremMailEnabledSecurityGroups.ps1 -InputCsvPath .\0222.input.csv

    Process all records in the input CSV file.

.EXAMPLE
    .\SM-M0222-Update-ExchangeOnPremMailEnabledSecurityGroups.ps1 -InputCsvPath .\0222.input.csv -WhatIf
...
.NOTES
    ...
    ------------------------------------  ----      --------  -----------
    SecurityGroupIdentity                 String    Yes       <fill in description>
