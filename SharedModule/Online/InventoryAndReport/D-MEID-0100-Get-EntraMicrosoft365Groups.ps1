...
.EXAMPLE
    .\SM-IR3008-Get-EntraMicrosoft365Groups.ps1 -InputCsvPath .\3008.input.csv

    Inventory the objects listed in the input CSV file.

.EXAMPLE
    .\SM-IR3008-Get-EntraMicrosoft365Groups.ps1 -DiscoverAll
...
param(
    ...
    [string]$OutputCsvPath = (Join-Path -Path (Join-Path -Path $PSScriptRoot -ChildPath 'InventoryAndReport_OutputCsvPath') -ChildPath ("Results_D-MEID-0100-Get-EntraMicrosoft365Groups_{0}.csv" -f (Get-Date -Format 'yyyyMMdd-HHmmss')))
)
