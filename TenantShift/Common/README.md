...
`Common` stores tenant shifts and helper assets used by all TenantShift scripts.
...
See [`CONTRIBUTING.md`](../Development/CONTRIBUTING.md) for the full circular dependency rule and the developer guide.
