...
$modifyRows = @(
    @{ Id='M3001'; Script='Online\Modify\M3001-Update-EntraUsers.ps1'; Input='Online\Modify\M3001-Update-EntraUsers.input.csv'; NeedsSp=$false; Notes='Update Entra user attributes (expanded model)' },
    @{ Id='M3002'; Script='Online\Modify\M3002-Set-EntraUserAccountState.ps1'; Input='Online\Modify\M3002-Set-EntraUserAccountState.input.csv'; NeedsSp=$false; Notes='Set Entra user account enabled/disabled state' },
    ...
    @{ Id='M3005'; Script='Online\Modify\M3005-Update-EntraAssignedSecurityGroups.ps1'; Input='Online\Modify\M3005-Update-EntraAssignedSecurityGroups.input.csv'; NeedsSp=$false; Notes='Update assigned security group properties' },
    @{ Id='M3006'; Script='Online\Modify\M3006-Update-EntraDynamicUserSecurityGroups.ps1'; Input='Online\Modify\M3006-Update-EntraDynamicUserSecurityGroups.input.csv'; NeedsSp=$false; Notes='Update dynamic user security group properties' },
    ...
    @{ Id='M3008'; Script='Online\Modify\M3008-Update-EntraMicrosoft365Groups.ps1'; Input='Online\Modify\M3008-Update-EntraMicrosoft365Groups.input.csv'; NeedsSp=$false; Notes='Update Microsoft 365 group properties' },
