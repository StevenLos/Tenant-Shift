...
function Start-RunTranscript {
    ...
    try {
        Start-Transcript -LiteralPath $transcriptPath -Force -WhatIf:$false -ErrorAction Stop | Out-Null
    }
    catch {
...
function Stop-RunTranscript {
    ...
    try {
        Stop-Transcript -WhatIf:$false -ErrorAction Stop | Out-Null
    }
    catch {
...
function Import-ValidatedCsv {
    ...
    $parser = [Microsoft.VisualBasic.FileIO.TextFieldParser]::new($InputCsvPath)
...
function ConvertTo-NullableDateTime {
    ...
    try {
        ...
        throw "Invalid datetime value '$text'. Use an ISO-like value (for example 2026-03-02 or 2026-03-02T10:30:00)."
    }
}
